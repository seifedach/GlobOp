...
def SuGD_Dynamic(model, criterion, batch, optimizer, device, alpha=0.9, sugd_iters=2, w=0.2, output="up"):
    x_sample, y_sample = batch
    x_sample, y_sample = x_sample.to(device), y_sample.to(device)
    ...
    # Dynamic bounds
    lr1 = current_lr * alpha       # lower bound
    lr2 = current_lr / alpha       # upper bound
